...
downloads: [{"filename": "p2-component-rules.md", "label": "Component Rules 참고", "outputName": "component-rules.md"}]
---
...
첨부 파일 **component-rules.md**를 AI에 함께 첨부하여 참조합니다.
(앱 스킬 복사 화면에서 `↓ Component Rules 참고` 버튼으로 다운로드 가능)
